...
//Draw screen information, lives, shields and score.
void drawInfo() {
...
//Draw ship, and shields around the center point if applicable.
void drawShip() {
	if(shields > 0) {
...
//Check linked lists for shots and draw them at individual positions.
...
//Check linked lists for rocks and draw them at individual positions.
...
//Start screen with title, how to start, and floating asteroids screensaver.
void startScreen() {
	drawRocks(asteroids);
...
//End screen shows score, time survived, and how to restart.
void endScreen() {
	graphics->setTextSize(5);
	graphics->setCursor(100,50);
